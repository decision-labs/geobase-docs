...
This guide will help you get started with Geobase and build your first app. For AI on satellite imagery, see the [GeoAI Quickstart](https://docs.geobase.app/geoai) or [Live Demo](https://docs.geobase.app/geoai-live).
