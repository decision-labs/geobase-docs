...
This tutorial demonstrates how to create embeddings for geospatial data using OpenStreetMap (OSM) and store them in a geobase database. We will use the following Python libraries: `srai`, `geopandas`, and `sqlalchemy`.
