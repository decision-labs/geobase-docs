# Creating Embeddings and Storing in Geobase

This tutorial demonstrates how to create geospatial embeddings with data from OpenStreetMap (OSM) and store them in your geobase project database. We will use the following Python libraries: `srai`, `geopandas`, and `sqlalchemy`.

## What are Geospatial Embeddings?

Geospatial embeddings are vector representations of geographical regions that capture the spatial relationships and characteristics of the features present within those regions. These embeddings can be used for various geospatial analysis tasks, such as clustering, classification, and visualization.
