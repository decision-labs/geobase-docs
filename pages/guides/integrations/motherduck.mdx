...
<Callout type="default" emoji="🎉">
  Woho! You have successfully created a foreign server for MotherDuck. Which means you can run queries on the MotherDuck from with-in geobase! 🚀
</Callout>
...
MotherDuck tables are now visible in geobase. 🎉
...
We are going to upload the `chicago_crime_dataset_pa.parquet` table to MotherDuck. File can be downloaded from [here](https://geobase-docs.s3.amazonaws.com/chicago_crime_dataset_pa.parquet).
