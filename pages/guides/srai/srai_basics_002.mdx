...
# Multidimensional Embeddings for Geospatial Data with Hex2Vec and Storing in Geobase

This tutorial demonstrates how to create hex2vec embeddings for geospatial data using srai and store them in a geobase database. We will use the following Python libraries: `srai` (version `0.7.5`), `geopandas`, and `sqlalchemy`.
...
![Enable pgvector Extension](./images/enable-pgvector-studio.gif)
