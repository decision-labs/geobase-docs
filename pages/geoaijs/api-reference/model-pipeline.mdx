...
Returns `ObjectDetectionResults` or `SegmentationResults` depending on the task(s).
...
Task chaining enables sophisticated geospatial analysis by connecting multiple AI models in sequence.
...
Ready to implement geospatial AI in your applications? Here are some recommended next steps:

- **Explore Tasks**: Browse [Supported Tasks](../supported-tasks/) for detailed documentation on each AI capability
- **Optimize Performance**: Check out [Performance Optimization](../guides/performance-optimization.md) for best practices
- **Learn by Example**: Visit our [Tutorials](../tutorials/) for hands-on, step-by-step implementation guides
- **Integration Guide**: See [React Integration](../react-integration.md) for frontend framework specifics

<Callout type="info" emoji="ℹ️">
  For production deployments, review our performance optimization guide to ensure optimal resource usage and response times.
</Callout>
